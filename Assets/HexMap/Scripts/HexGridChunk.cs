...
public class HexGridChunk : MonoBehaviour {
    ...
    void TriangulateWithRiver(HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e)
    {
        ...
        middle.v3.y = center.y = e.v3.y;

        TriangulateEdgeStrip(middle, color1, cell.TerrainTypeIndex, e, color1, cell.TerrainTypeIndex);
    ...
    void TriangulateRoad(Vector3 center, Vector3 mL, Vector3 mR,
